...
Чтобы отличить причины 2–4 без гадания, спросите у CLI, каким каналом класс
...
«Источников не найдено» сужает круг до проблемы скана (2–3) или динамического
класса (4).
...
селекторам, **конфликты токенов** между слоями, итоговые скан‑globs и
